...
URL = "https://tgs-filter-bot-2.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://tgs-filter-bot-2.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://tgs-filter-bot-2.onrender.com/".format(FQDN)
else:
    URL = "https://tgs-filter-bot-2.onrender.com/".format(FQDN)
